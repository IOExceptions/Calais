...
@Table(name = "jls_website_programme")
public class JlsWebsiteProgramme implements Serializable {
    /**
     * id
     */
    @Id
     ...
     * 获取是否显示在首页(0假,1真)
     *
     * @return main_show_ - 是否显示在首页(0假,1真)
     */
    ...
    public boolean equals(Object that) {
        ...
        JlsWebsiteProgramme other = (JlsWebsiteProgramme) that;
