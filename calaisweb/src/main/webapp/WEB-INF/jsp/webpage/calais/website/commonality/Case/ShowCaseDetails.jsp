...
<div class="about-breadcrumb">
	<div class="container">
		<ul>
			...
			<li><a href="<%=basePath%>/GongsiNewsPage">成功案例</a><i>></i></li>
			<li>${requestScope.data.data.title}</li>
		</ul>
	</div>
</div>
	...
	<div class="container" >
	   	<div class="row">
			 ...
			 <div class="col-md-12 contenttext" >
			 		<h3 style="width:100%; text-align: center; color:#430272">${requestScope.data.data.title}</h3>
			 		<p  style="width:100%; text-align: center; color:#430272">作者:${requestScope.data.data.editor}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;阅读量:${requestScope.data.data.num}</p>
			 		<HR style="border:1px dotted #430272;">
			 		<div>
			 				${requestScope.data.data.content}
			 		</div>
			 		<HR style="border:1px dotted #430272;">
			 </div>
		</div>
...
$(function(){
console.log('${requestScope.data.last}');
console.log('${requestScope.data.next}');
})
/****
 * 转换一个字符串日期格式然后返回日期对象
 */
