...
<title>我们的风采-展示墙</title>
<!-- js -->
	<script type="text/javascript" src="<%=basePath%>/static/public/jquery/jquery-3.2.1.min.js"></script>
	<script type="text/javascript" src="<%=basePath%>/static/public/album/js/jssor.slider-21.1.6.mini.js"></script>
...
<body>
	<div id="jssor_1" style="position: relative; margin: 0 auto; top: 20px; left: 0px; width: 960px; height: 480px; overflow: hidden; visibility: hidden; background-color: #24262e;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;" id="galleryShowDiv">
            <c:forEach items="${requestScope.data}" varStatus="i" var="item" >  
		            <div data-p="150.00">
		                <img data-u="image" src="<%=basePath%>${item.path}"/>
		                <img data-u="thumb" src="<%=basePath%>${item.path}" />
		            </div>
	        </c:forEach>           
